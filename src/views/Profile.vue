...
const profile = reactive({
    fullName: 'Bastián Maldonado',
    position: 'Automation and Robotics Engineer & Front-End Developer',
});
</script>
<template>
    <div class="container">
        <div class="profile">
            ...
            <div class="profile__text">
                <h1
                    class="text-uppercase font-weight-regular text-deep-orange-accent-1"
                    :class="[xs ? 'text-h3' : 'text-h2', { 'mt-5': smAndDown }]"
                >
                    {{ profile.fullName }}
                </h1>
                <h2 class="text-h5 text-uppercase font-weight-light mt-5 text-deep-orange-lighten-1">
                    {{ profile.position }}
                </h2>
            </div>
        </div>
